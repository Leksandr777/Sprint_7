...
class TestCreateCourier:
    ...
    def test_create_duplicate_courier(self, base_url, new_courier):
    ...
    def test_create_without_required_fields(self, base_url, missing_field):
        payload = {
            "login": f"test_login_{random.randint(1, 9999)}",
            "password": f"test_pass_{random.randint(1, 9999)}",
    ...
    def test_empty_fields(self, base_url, empty_field):
